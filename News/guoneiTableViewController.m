...
@interface guoneiTableViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation guoneiTableViewController
{
    int cellCount;
}
...
- (void)loadNewData
{
    ...
    [manager GET:@"http://v.juhe.cn/toutiao/index" parameters:@{@"type" : @"guonei",
