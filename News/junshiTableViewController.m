...
@interface junshiTableViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation junshiTableViewController
{
    int cellCount;
}
...
- (void)loadNewData
{
    ...
    [manager GET:@"http://v.juhe.cn/toutiao/index" parameters:@{@"type" : @"junshi",
