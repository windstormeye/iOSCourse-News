...
@interface shishangTableViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation shishangTableViewController
{
    int cellCount;
}
...
- (void)loadNewData
{
    ...
    [manager GET:@"http://v.juhe.cn/toutiao/index" parameters:@{@"type" : @"shishang",
