...
@interface guojiTableViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation guojiTableViewController
{
    int cellCount;
}
...
- (void)loadNewData
{
    ...
    [manager GET:@"http://v.juhe.cn/toutiao/index" parameters:@{@"type" : @"guoji",
