...
@interface shehuiTableViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation shehuiTableViewController
{
    int cellCount;
}
...
- (void)loadNewData
{
    ...
    [manager GET:@"http://v.juhe.cn/toutiao/index" parameters:@{@"type" : @"shehui",
